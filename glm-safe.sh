#!/bin/bash
# GLM 5.2 via Free Claude Code — single command launcher (safe mode)
...
cd "$ORIGINAL_DIR"
ANTHROPIC_AUTH_TOKEN="freecc:open_router/z-ai/glm-5.2" ANTHROPIC_BASE_URL="http://localhost:$PORT" claude "$@"
