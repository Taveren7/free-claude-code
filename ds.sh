#!/bin/bash
# DeepSeek via Free Claude Code — single command launcher (skip permissions)
...
cd "$ORIGINAL_DIR"
ANTHROPIC_AUTH_TOKEN="freecc" ANTHROPIC_BASE_URL="http://localhost:$PORT" claude --dangerously-skip-permissions "$@"
